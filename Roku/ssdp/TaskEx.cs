    ...
    internal static class TaskEx
    {
        ...
        public static Task Delay(TimeSpan period)
        {
            if (period.TotalMilliseconds > int.MaxValue)
                throw new ArgumentOutOfRangeException(nameof(period), string.Format(CultureInfo.InvariantCulture, "period cannot be more than {0} millseconds.", period.TotalMilliseconds));
